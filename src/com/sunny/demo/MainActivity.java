...
import com.sunny.demo.view.SwipeLayout;
import com.sunny.demo.view.SwipeLayout.OnSwipeChangeListener;
...
public class MainActivity extends Activity {
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.swipeLayout.setSwipeChangeListener(new OnSwipeChangeListener() {
